...
export class PatternSelectorPopup {
  ...
  constructor(private loadNames: () => Promise<string[]>) {
  ...
  private buildOverlay(): HTMLElement {
    ...
    // List
    this.listEl = el('ul', 'ps-list') as HTMLUListElement;
    ...
    const cancelBtn = el('button', 'ps-btn ps-btn-cancel') as HTMLButtonElement;
    cancelBtn.textContent = 'Cancel';
    cancelBtn.addEventListener('click', () => this.close(null));

    this.loadBtn = el('button', 'ps-btn ps-btn-load') as HTMLButtonElement;
  ...
  private renderList(names: string[]): void {
    ...
    for (const name of names) {
      const item = el('li', 'ps-item') as HTMLLIElement;
  ...
  private selectItem(item: HTMLLIElement, name: string): void {
    this.listEl
      .querySelectorAll<HTMLLIElement>('.ps-item')
